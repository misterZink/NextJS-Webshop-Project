...
export default function Varukorg() {
    ...
    function displayDogs() {
        return dogs.map(dog => <div key={dog.dogName}><span
            className="bg-gray-200 rounded block ...">{dog.dogName}&emsp;&emsp;&emsp;&emsp;{dog.price} :-</span></div>)
    }
            ...
            <form className="w-full max-w-lg mt-10 mb-5">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-zip" type="text" placeholder="telefonnummer" max="256"/>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-city" type="text" placeholder="adress" max="256"/>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-first-name" type="text" placeholder="**** **** **** ****" maxLength="16"/>
                    ...
                    <div className="w-full md:w-1/6 px-3">
                        ...
                        <input
                            ...
                            id="grid-last-name" type="text" placeholder="**" maxLength="2"/>
                    </div>
